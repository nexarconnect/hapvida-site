...
export default function Body() {
  return (
    <>
      <p>
        Quem mora em Aracaju e pesquisa plano de saúde Hapvida esbarra sempre na mesma dúvida: quanto custa
      ...
      <h2>Quanto custa o plano Hapvida em Aracaju</h2>
      <p>
        Hoje o valor de entrada divulgado para Aracaju é R$ 145,96 (plano Mix), mas esse número muda
        conforme a faixa etária e a modalidade contratada (individual, familiar ou empresarial); duas
        pessoas de idades diferentes em Aracaju podem receber valores bem distintos.
      </p>
      <p>
        Por isso, o número exato do seu perfil só sai na cotação. Confira os planos disponíveis e solicite o
        valor atualizado para Aracaju na{' '}
        <Link to="/plano-hapvida/aracaju">página do plano Hapvida em Aracaju</Link>, direto pelo WhatsApp com
        um consultor autorizado.
      </p>

      <h2>Como funciona a rede em Aracaju</h2>
      <p>
        ...
        delas você acessa em Aracaju depende do plano contratado, não é igual para todos. A consultoria
        Nexar atende em Aracaju com suporte local, e o consultor confirma quais unidades ficam disponíveis
      ...
      <div className="not-prose space-y-4">
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          <h3 className="!mt-0 font-black text-slate-900">Qual o valor do plano Hapvida em Aracaju?</h3>
          <p className="!mt-2 text-sm text-slate-600">
            O valor de entrada divulgado hoje é R$ 145,96 (plano Mix), mas o valor exato do seu perfil depende
            da idade e da modalidade. Um consultor confirma o número certo na cotação para Aracaju.
          </p>
        </div>
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          <h3 className="!mt-0 font-black text-slate-900">Qual plano é mais barato em Aracaju?</h3>
          <p className="!mt-2 text-sm text-slate-600">
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          <h3 className="!mt-0 font-black text-slate-900">A rede atende em Aracaju?</h3>
          <p className="!mt-2 text-sm text-slate-600">
            Sim, por rede própria e credenciada. Qual delas você acessa depende do plano contratado, e a
            consultoria Nexar confirma as unidades disponíveis em Aracaju antes de qualquer decisão.
          </p>
        </div>
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          <h3 className="!mt-0 font-black text-slate-900">Quanto tempo depois de contratar já posso usar o plano em Aracaju?</h3>
          <p className="!mt-2 text-sm text-slate-600">
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          <h3 className="!mt-0 font-black text-slate-900">Dá para contratar sendo MEI em Aracaju?</h3>
          <p className="!mt-2 text-sm text-slate-600">
      ...
      <h2>Conclusão</h2>
      <p>
        Em Aracaju, o número que importa é o da sua idade, não a média divulgada. Solicite uma cotação sem
