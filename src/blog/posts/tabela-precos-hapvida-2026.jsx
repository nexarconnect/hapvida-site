...
export default function Body() {
  return (
    <>
      ...
      <ul>
        <li>
          <strong>Mix:</strong> a opção de menor mensalidade, pela rede própria Hapvida. Indicada para quem
          prioriza economia mensal.
        </li>
        <li>
          <strong>Nosso Plano:</strong> o de melhor custo-benefício do portfólio, também pela rede própria.
          Costuma ser o mais procurado por equilibrar preço e cobertura.
        </li>
        <li>
      ...
      <p>
        O Mix tem a menor mensalidade, pela rede própria Hapvida. O Nosso Plano tem o melhor custo-benefício
        do portfólio, também com rede própria. O Pleno oferece a cobertura mais completa e mais conforto no
        uso. Os três estão disponíveis nas modalidades individual, familiar, MEI e empresarial.
      </p>
