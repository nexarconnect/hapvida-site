...
export default function Body() {
  return (
    <>
      <p>
        Quem mora em Teresina e pesquisa plano de saúde Hapvida esbarra sempre na mesma dúvida: quanto custa
      ...
      <h2>Quanto custa o plano Hapvida em Teresina</h2>
      <p>
        Hoje o valor de entrada divulgado para Teresina é R$ 84,71 (plano Mix), mas esse número muda
        conforme a faixa etária e a modalidade contratada (individual, familiar ou empresarial); duas
        pessoas de idades diferentes em Teresina podem receber valores bem distintos.
      </p>
      <p>
        Por isso, o número exato do seu perfil só sai na cotação. Confira os planos disponíveis e solicite o
        valor atualizado para Teresina na{' '}
        <Link to="/plano-hapvida/teresina">página do plano Hapvida em Teresina</Link>, direto pelo WhatsApp com
        um consultor autorizado.
      </p>

      <h2>Como funciona a rede em Teresina</h2>
      <p>
        ...
        delas você acessa em Teresina depende do plano contratado, não é igual para todos. A consultoria
        Nexar atende em Teresina com suporte local, e o consultor confirma quais unidades ficam disponíveis
      ...
      <h2>Conclusão</h2>
      <p>
        Em Teresina, o número que importa é o da sua idade, não a média divulgada. Solicite uma cotação sem
