...
export default function Body() {
  return (
    <>
      ...
      <h3>Qual o valor do plano Hapvida em São Bernardo do Campo?</h3>
      <p>
      ...
      <h3>Qual plano é mais barato em São Bernardo do Campo?</h3>
      <p>
      ...
      <h3>A rede atende em São Bernardo do Campo?</h3>
      <p>
      ...
      <h3>Quanto tempo depois de contratar já posso usar o plano em São Bernardo do Campo?</h3>
      <p>
      ...
      <h3>Dá para contratar sendo MEI em São Bernardo do Campo?</h3>
      <p>
