  ...
  return (
    <div className="w-64 min-h-screen bg-slate-900 text-white p-6 flex flex-col">
      ...
      <nav className="flex-1 space-y-2">
        ...
        <Link to="/admin/crm" className="block p-3 hover:bg-slate-800 rounded-lg transition">🗂️ CRM</Link>
        <Link to="/admin/analytics" className="block p-3 hover:bg-slate-800 rounded-lg transition">📈 Analytics</Link>
