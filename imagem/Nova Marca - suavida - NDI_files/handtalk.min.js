...
`),({zIndex:e})=>e),W=u.default.div(F||(F=P`
  ...
  ${0}
`),({side:e})=>"left"===e?"left: 0;":"right: 0;",({align:e,customButtonStyle:t,isMobile:r})=>t&&r?"bottom: 0;":h.alignmentMap[e]||h.alignmentMap.default),V=u.default.div(H||(H=P`
  position: absolute;
  pointer-events: auto;
  bottom: 0;
  top: auto;
  ${0}
  max-height: 100vh;
`),({side:e})=>"left"===e?"left: 0;":"right: 0;"),Z=u.default.div(Q||(Q=P`
  position: fixed;
  pointer-events: auto;
  ${0}
`),({side:e})=>"left"===e?"left: 0;":"right: 0;"),q=u.default.div(Y||(Y=P`
  display: flex;
